...
Every "ChatGPT vs Claude for writing" article on the internet says the same thing: *Claude writes better, ChatGPT is more flexible, you should probably use both.* Then it gives you a feature checklist and a pricing table and calls it a comparison.
...
3. **Did it actually do the job?**

No vibes. No "feels more thoughtful." Just usable / not usable.

## Test 1: Blog post intro (500 words)
...
## Test 2: Cold email to a CEO

**The prompt:**
> Write a cold email to the CEO of a mid-sized SaaS company. I help SaaS companies cut their customer support response time by 60% by setting up AI triage workflows. I want a 30-min call. Keep it under 100 words. Don't be salesy.
...
## Test 3: Five ad headlines for a productivity app

**The prompt:**
> Write 5 different ad headlines for a productivity app called Sift that helps users cut their inbox to zero in 15 minutes a day. Each headline should be under 10 words and use a different angle (urgency, curiosity, contrarian, social proof, benefit-driven).

**ChatGPT-5:**
1. *Empty your inbox in 15 minutes. Every day.*
2. *Most inbox-zero advice is wrong. Try this instead.*
3. *Join 40,000 people who beat email overload.*
4. *Your inbox is eating your morning. Sift fixes that.*
5. *What if your inbox took 15 minutes a day?*

Clean, on-brief, hits each angle. The "40,000 people" claim is fabricated but that's standard ad-headline practice. Usable as a first draft.

**Claude Sonnet 4.6:**
1. *15 minutes. Inbox zero. Every day.*
2. *Stop replying. Start sorting. Sift handles it.*
3. *Why "inbox zero" advice has been lying to you.*
...
## Test 4: LinkedIn post (200 words)

**The prompt:**
> Write a 200-word LinkedIn post about why I stopped using my Pomodoro timer after 5 years. The conclusion is that the timer was making me anxious about every minute, not productive. Sound like a real person, not a LinkedIn guru. Don't use 🚀 or one-line paragraphs.

**ChatGPT-5:**
Despite the explicit instructions, it produced a post with one-line paragraphs separated by white space. The content was fine but the structure was the exact format I told it not to use. *"I used my Pomodoro timer for 5 years.\n\nIt worked. Until it didn't.\n\nHere's what I learned."*
...
**Verdict:** ChatGPT. For factual, structured technical writing where precision matters more than voice, GPT-5 is more reliable. **ChatGPT.**

## Test 6: Short fiction (opening of a short story)

**The prompt:**
> Write the opening 300 words of a literary short story. Setting: a small coastal town in late autumn. Protagonist: a retired lighthouse keeper. Mood: melancholy but not sentimental. No clichés.
...
| Task | Winner | Why |
|------|--------|-----|
| Blog post intro | Claude | Less editing needed |
| Cold email | Tie (leans Claude) | Risk vs safety call |
| Ad headlines | Claude | Sharper output, looser brief-following |
| LinkedIn post | Claude | ChatGPT couldn't follow format rules |
| Technical docs | ChatGPT | More precise, less interpretive |
| Short fiction | Claude | Not close |
...
- **ChatGPT Pro**: $200/month (mostly for power users with heavy reasoning needs)
...
- **You write for a living, write under your own name, or care about voice → Claude Pro.** Period.
- **You write a lot of structured/templated content, technical docs, or use lots of ChatGPT-only features like image generation → ChatGPT Plus.**
- **You're not sure → Claude Pro.** The default Claude voice needs less editing for most use cases, and that compounds.

If you can afford both ($40/month combined):

This is what I do. Claude for writing-writing, ChatGPT for everything else (research summaries, image generation, voice mode, any time I need a quick structured output). The split is roughly 70/30 in Claude's favor for me, but your mileage will vary depending on what you write.
...
*Want more comparisons like this? The next one tests Claude vs ChatGPT vs Gemini for research tasks specifically. Subscribe to the [blog](/blog) or check the [about page](/about) to see what Toolbase is about.*
