...
*Once the SOPs exist, the rest of the first-hire framework follows. The decision of when to hire is in [when to make your first hire as a solo founder](/blog/when-to-make-first-hire-solopreneur/). The contractor-vs-employee question is in [contractor vs first employee in India](/blog/contractor-vs-employee-first-hire-india/). The tooling that supports the SOPs at one to three users is in [the 1-to-3 person tech stack that scales without rebuild](/blog/tech-stack-solo-to-three-person/). The first 90 days with the hire are in [the first hire 30/60/90 onboarding playbook](/blog/first-hire-onboarding-30-60-90/).*
