...
- Cream background **#F4EBD8**
- Charcoal black ink lines **#1A1A1A**
- Burnt orange accent **#E07856** (only color)
- Hand-drawn editorial feel, generous negative space
- Flat 2D, no shading, no gradients
- No text in the image

After generating each image, save the `.webp` file at:
`c:/Users/krish/Desktop/solo-os/toolbase/_library/assets/{slug}.webp`
(replace the placeholder of the same name)

When the article publishes (via `publish-due.mjs`), the asset moves automatically.
